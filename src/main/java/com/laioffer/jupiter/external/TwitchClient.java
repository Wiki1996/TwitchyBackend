...
public class TwitchClient {
    private static final String TOKEN = "Bearer q9tyycdq635fw6rw1brud032bteu70";
    private static final String CLIENT_ID = "h8ra3pl77od2o1l1gl1l3iak1xwfan";
    ...
    //Returns items for a specific type
